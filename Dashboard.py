...
def formata_numero(valor, prefixo=""):
    ...
    elif valor > 1000 and valor < 999999:
        valor /= 1000
...
with aba3:
    qtd_vendedores = st.number_input("Quantidade de cendedores", 2, 10, 5)
    col1, col2 = st.columns(2)
    with col1:
        st.metric("Receita", formata_numero(dados["Preço"].sum(), "R$"))
    ...
    with col2:
        ...
        fig_vendas_vendedores = px.bar(vendedores[["count"]].sort_values("count",ascending=False).head(qtd_vendedores),
                                        ...
                                        text_auto=True,
                                        title= f"Top {qtd_vendedores} vendedores (quantidades de vendas)")
